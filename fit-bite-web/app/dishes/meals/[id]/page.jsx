      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <p class="leading-relaxed">{itemData && itemData.description}</p>
            <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div class="flex">
                <div class="mr-3 flex ">
                  Nutrient Requirements
                  <p class=" border-gray-300  p-2 text-indigo-500  focus:outline-none">
            ...
            <div class="flex">
              ...
              <Link href="/Checkout">
                <button
                  onClick={() =>
                    addtoCart(itemData.id, 1, itemData.price, itemData.dish_name, "https://res.cloudinary.com/dkv7cimyy/image/upload/v1740123654/hack2/k7y0mnlaufgojdj3g47t.jpg")
                  }
