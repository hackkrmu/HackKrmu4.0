        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p class="leading-relaxed">{dish && dish.description}</p>
              ...
              <div class="flex">
                ...
                <Link href="/Checkout">
                  <button
                    onClick={() =>
                      addtoCart(dish.id, 1, dish.price, dish.dish_name, "https://res.cloudinary.com/dkv7cimyy/image/upload/v1740123654/hack2/k7y0mnlaufgojdj3g47t.jpg")
                    }
